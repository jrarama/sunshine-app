 ...
 */
package com.jrarama.android.sunshine.app.data;
...
import com.jrarama.android.sunshine.app.data.WeatherContract.LocationEntry;
...
public class TestDb extends AndroidTestCase {
    ...
    */
    public void testLocationTable() {
        ...
        assertTrue("Error: table does not contain rows", cursor.moveToFirst());

        // Validate data in resulting Cursor with the original ContentValues
        // (you can use the validateCurrentRecord function in TestUtilities to validate the
        // query if you like)

        TestUtilities.validateCurrentRecord("Error: table data does not match", cursor, values);

        assertFalse("Error: table contain more rows", cursor.moveToNext());
    ...
    public void testWeatherTable() {
        ...
        long locationId = insertLocation();
        assertTrue("Error: cannot insert location", locationId != -1);
        ...
        assertTrue("Error: Cannot insert weather", weatherId != -1);
        // Query the database and receive a Cursor back
        ...
        // Move the cursor to a valid database row
        assertTrue("Error: weather has no records", cursor.moveToFirst());

        // Validate data in resulting Cursor with the original ContentValues
        // (you can use the validateCurrentRecord function in TestUtilities to validate the
        // query if you like)

        TestUtilities.validateCurrentRecord("Weather values are not the same", cursor, values);
        assertFalse("Error: weather table contains more than one record", cursor.moveToNext());
        // Finally, close the cursor and database
